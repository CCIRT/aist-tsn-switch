...
source [file join [file dirname [file dirname [info script]]] gui/get_frame_length_v1_0.gtcl]
...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ENABLE_TIMESTAMP_FOOTER" -parent ${Page_0}
...
proc update_PARAM_VALUE.ENABLE_TIMESTAMP_FOOTER { PARAM_VALUE.ENABLE_TIMESTAMP_FOOTER } {
	# Procedure called to update ENABLE_TIMESTAMP_FOOTER when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ENABLE_TIMESTAMP_FOOTER { PARAM_VALUE.ENABLE_TIMESTAMP_FOOTER } {
	# Procedure called to validate ENABLE_TIMESTAMP_FOOTER
	return true
}
...
proc update_MODELPARAM_VALUE.ENABLE_TIMESTAMP_FOOTER { MODELPARAM_VALUE.ENABLE_TIMESTAMP_FOOTER PARAM_VALUE.ENABLE_TIMESTAMP_FOOTER } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ENABLE_TIMESTAMP_FOOTER}] ${MODELPARAM_VALUE.ENABLE_TIMESTAMP_FOOTER}
}
