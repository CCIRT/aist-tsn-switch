...
source [file join [file dirname [file dirname [info script]]] gui/ethernet_frame_arbiter_v1_0.gtcl]
...
=======
  ...
  ipgui::add_param $IPINST -name "FRAME_GAP" -parent ${Page_0}
>>>>>>> dbb0d5b (AIST-TSN Switch V2.0 First commit)
...
proc update_PARAM_VALUE.FRAME_GAP { PARAM_VALUE.FRAME_GAP } {
	# Procedure called to update FRAME_GAP when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FRAME_GAP { PARAM_VALUE.FRAME_GAP } {
	# Procedure called to validate FRAME_GAP
	return true
}


proc update_MODELPARAM_VALUE.FRAME_GAP { MODELPARAM_VALUE.FRAME_GAP PARAM_VALUE.FRAME_GAP } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FRAME_GAP}] ${MODELPARAM_VALUE.FRAME_GAP}
}
