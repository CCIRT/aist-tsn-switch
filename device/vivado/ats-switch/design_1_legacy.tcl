...
proc create_hier_cell_hier_calc_et_P01_3 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins connect_timestamp_0/s_axis] [get_bd_intf_pins fifo_generator_0/M_AXIS]
  ...
  # Create port connections
  connect_bd_net -net proc_sys_reset_sw_peripheral_aresetn [get_bd_pins rstn] [get_bd_pins axis_data_fifo_length_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_timestamp_0/s_axis_aresetn] [get_bd_pins connect_timestamp_0/rstn] [get_bd_pins detect_flow_0/rstn] [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins get_frame_length_0/rstn] [get_bd_pins process_frame_0/rstn] [get_bd_pins separate_timestamp_0/rstn]
  connect_bd_net -net temac_0_tx_mac_aclk [get_bd_pins clk] [get_bd_pins axis_data_fifo_length_0/s_axis_aclk] [get_bd_pins axis_data_fifo_timestamp_0/s_axis_aclk] [get_bd_pins connect_timestamp_0/clk] [get_bd_pins detect_flow_0/clk] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins get_frame_length_0/clk] [get_bd_pins process_frame_0/clk] [get_bd_pins separate_timestamp_0/clk]
...
proc create_hier_cell_hier_queue_ATS_P01_2_3 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins m_axis] [get_bd_intf_pins axis_register_slice_0/M_AXIS]
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins fifo_generator_0/M_AXIS] [get_bd_intf_pins separate_timestamp_0/s_axis]
  ...
  # Create port connections
  connect_bd_net -net proc_sys_reset_sw_peripheral_aresetn [get_bd_pins rstn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins et_queue_0/s_axis_aresetn] [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins frame_queue_0/s_axis_aresetn] [get_bd_pins separate_timestamp_0/rstn]
  connect_bd_net -net temac_0_tx_mac_aclk [get_bd_pins clk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins et_queue_0/s_axis_aclk] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins frame_queue_0/s_axis_aclk] [get_bd_pins separate_timestamp_0/clk]
...
proc create_hier_cell_hier_et_gate_P01_3 { parentCell nameHier } {
  ...
  connect_bd_net -net transmission_selection_timer_with_delay_1 [get_bd_pins transmission_selection_timer_with_delay] [get_bd_pins et_gate_0/transmission_selection_timer_with_delay] [get_bd_pins et_gate_1/transmission_selection_timer_with_delay] [get_bd_pins et_gate_2/transmission_selection_timer_with_delay]
...
proc create_hier_cell_hier_scheduler_3 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins hier_calc_et_P00/S_AXI1] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins hier_calc_et_P01/S_AXI] [get_bd_intf_pins smartconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins hier_calc_et_P01/S_AXI1] [get_bd_intf_pins smartconnect_0/M04_AXI]
...
proc create_hier_cell_hier_eth_switch { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_1 [get_bd_intf_pins S00] [get_bd_intf_pins channel_in_opt_0/s_axis]
  connect_bd_intf_net -intf_net S01_1 [get_bd_intf_pins S01] [get_bd_intf_pins channel_in_opt_1/s_axis]
  connect_bd_intf_net -intf_net S02_1 [get_bd_intf_pins S02] [get_bd_intf_pins channel_in_opt_2/s_axis]
  connect_bd_intf_net -intf_net S03_1 [get_bd_intf_pins S03] [get_bd_intf_pins channel_in_opt_3/s_axis]
  ...
  connect_bd_intf_net -intf_net channel_in_opt_0_m_axis [get_bd_intf_pins axis_interconnect_s00/S00_AXIS] [get_bd_intf_pins channel_in_opt_0/m_axis]
  ...
  connect_bd_intf_net -intf_net channel_in_opt_1_m_axis [get_bd_intf_pins axis_interconnect_s01/S00_AXIS] [get_bd_intf_pins channel_in_opt_1/m_axis]
  ...
  connect_bd_intf_net -intf_net channel_in_opt_2_m_axis [get_bd_intf_pins axis_interconnect_s02/S00_AXIS] [get_bd_intf_pins channel_in_opt_2/m_axis]
  ...
  connect_bd_intf_net -intf_net channel_in_opt_3_m_axis [get_bd_intf_pins axis_interconnect_s03/S00_AXIS] [get_bd_intf_pins channel_in_opt_3/m_axis]
  ...
  connect_bd_net -net temac_0_tx_mac_aclk [get_bd_pins aclk] [get_bd_pins axis_interconnect_s00/ACLK] [get_bd_pins axis_interconnect_s00/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_s00/M01_AXIS_ACLK] [get_bd_pins axis_interconnect_s00/M02_AXIS_ACLK] [get_bd_pins axis_interconnect_s00/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_s01/ACLK] [get_bd_pins axis_interconnect_s01/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_s01/M01_AXIS_ACLK] [get_bd_pins axis_interconnect_s01/M02_AXIS_ACLK] [get_bd_pins axis_interconnect_s01/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_s02/ACLK] [get_bd_pins axis_interconnect_s02/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_s02/M01_AXIS_ACLK] [get_bd_pins axis_interconnect_s02/M02_AXIS_ACLK] [get_bd_pins axis_interconnect_s02/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_s03/ACLK] [get_bd_pins axis_interconnect_s03/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_s03/M01_AXIS_ACLK] [get_bd_pins axis_interconnect_s03/M02_AXIS_ACLK] [get_bd_pins axis_interconnect_s03/S00_AXIS_ACLK] [get_bd_pins axis_register_slice_in/aclk] [get_bd_pins axis_switch_0/aclk] [get_bd_pins channel_in_opt_0/aclk] [get_bd_pins channel_in_opt_1/aclk] [get_bd_pins channel_in_opt_2/aclk] [get_bd_pins channel_in_opt_3/aclk] [get_bd_pins mactable_mod_0/aclk]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_parameters_0_processing_delay_max [get_bd_pins axi_gpio_parameters_0/processing_delay_max] [get_bd_pins c_addsub_0/B]
  ...
  connect_bd_net -net temac_0_tx_mac_aclk [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins axis_clock_converter_2/s_axis_aclk] [get_bd_pins axis_clock_converter_3/s_axis_aclk] [get_bd_pins axis_data_fifo_swin_0/m_axis_aclk] [get_bd_pins axis_data_fifo_swin_0/s_axis_aclk] [get_bd_pins axis_data_fifo_swin_1/m_axis_aclk] [get_bd_pins axis_data_fifo_swin_2/m_axis_aclk] [get_bd_pins axis_data_fifo_swin_3/m_axis_aclk] [get_bd_pins c_addsub_0/CLK] [get_bd_pins axi_gpio_parameters_0/clk] [get_bd_pins hier_ats_0/aclk] [get_bd_pins hier_ats_1/aclk] [get_bd_pins hier_ats_2/aclk] [get_bd_pins hier_ats_3/aclk] [get_bd_pins hier_eth_switch/aclk] [get_bd_pins hier_flow_control/fifo_wr_clk] [get_bd_pins hier_mac_0/tx_mac_aclk] [get_bd_pins hier_scheduler_0/clk] [get_bd_pins hier_scheduler_1/clk] [get_bd_pins hier_scheduler_2/clk] [get_bd_pins hier_scheduler_3/clk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins proc_sys_reset_sw/slowest_sync_clk] [get_bd_pins reference_timer_0/clk] [get_bd_pins register_slice_0/clk] [get_bd_pins smartconnect_0/aclk]
