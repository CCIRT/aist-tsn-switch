...
└── tsn_efcc          : Python module for EFCC
```
...
tsn_efcc provides easy frame generate/capture interface of EFCC (Ethernet Frame Crafter & Capture).
The following functions are provided:

- Test frame generation
- Test frame capture and compute statistics

To show usage of tsn_efcc, please refer to [EFCC](https://github.com/CCIRT/aist-tsn-efcc).
