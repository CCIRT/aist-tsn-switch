...
def main():
    ...
    parser.set_defaults(send_port0=0, send_port1=1, recv_port=3, board='u45n')
    parser.add_argument('--rates', default=[0, 2000, 4000, 6000, 8000, 10000], type=int, nargs='+', help='test rates')
