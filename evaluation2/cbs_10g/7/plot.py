...
targets1 = ['(A) TC6', '(B) TC6 + TC7', '(C) TC6 + TC5(9000M)', '(D) TC6 + TC7 + TC5(9000M)']

plot(label_and_results, lambda label: label in targets1, 'results/latency.png', 'results/diff.png')

targets2 = ['(A) TC6', '(B) TC6 + TC7', '(C) TC6 + TC5(9000M)', '(D) TC6 + TC7 + TC5(9000M)']
for rate in [8000, 7000, 6000, 5000, 4000, 3000, 2000, 1000]:
    targets2.append(f'(D) TC6 + TC7 + TC5({rate}M)')
