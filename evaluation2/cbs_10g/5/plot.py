...
results = {}
results_ts = {}
for rate in [0, 1000, 3000, 5000, 7000, 9000, 9500]:
...
plot_latency_hist(results_ts, 156.25, f'results/hist.png')
plot_latency_points(results_ts[5000], 156.25, 'results/each_frame_5000.png')
