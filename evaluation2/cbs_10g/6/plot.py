...
dir_and_labels = [('tc7_only', '(A) TC7'),
                  ('tc7_tc6_10000', '(B) TC7 + TC6'),
                  ]
for rate in [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000]:
    dir_and_labels.append((f'tc7_tc5_{rate}', f'(C) TC7 + TC5({rate}M)'))

for rate in [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000]:
    dir_and_labels.append((f'tc7_tc6_1000_tc5_{rate}', f'(D) {rate}M'))
    # dir_and_labels.append((f'tc7_tc6_1000_tc5_{rate}', f'(D) TC7 + TC6 + TC5({rate}M)'))
...
def plot(label_and_results, label_filter, filename, filename2):
    ...
    plt.legend()
    plt.title('Latency of TC7: min, max: (D) TC7(970M) + TC6(1000M) + TC5(x-axis)')
...
targets1 = ['(A) TC7', '(B) TC7 + TC6', '(C) TC7 + TC5(9000M)', '(D) 9000M']
targets2 = ['(A) TC7', '(B) TC7 + TC6', '(C) TC7 + TC5(9000M)', '(D) 9000M']
# targets1 = ['(A) TC7', '(B) TC7 + TC6', '(C) TC7 + TC5(9000M)', '(D) TC7 + TC6 + TC5(9000M)']
# targets2 = ['(A) TC7', '(B) TC7 + TC6', '(C) TC7 + TC5(9000M)', '(D) TC7 + TC6 + TC5(9000M)']
for rate in [8000, 7000, 6000, 5000, 4000, 3000, 2000, 1000]:
    targets2.append(f'(D) {rate}M')
