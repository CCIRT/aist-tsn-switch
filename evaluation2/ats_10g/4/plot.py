...
def plot_bandwidth(bandwidths, filename):
    ...
    expected_y1 = 1000 * l2_frame_len / l1_frame_len
    expected_y2 = 2000 * l2_frame_len / l1_frame_len
...
bandwidths = []
bandwidths.append(BandwidthSummary('results/cirs_1000_2000/port0_summary_bandwidth.txt'))
bandwidths.append(BandwidthSummary('results/cirs_1000_2000/port1_summary_bandwidth.txt'))

plot_bandwidth(bandwidths, 'results/receive_rate.png')
plot_interval(TimestampSummary('results/cirs_1000_2000/recv.csv'), 156.25, 'results/interval.png')
