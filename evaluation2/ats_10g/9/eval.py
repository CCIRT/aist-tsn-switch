...
def main():
    print('Evaluation 9: Measure the latency of the 1st priority ATS flow competing with the 2nd priority ATS flow and the best-effort flow.')
    parser = utility.common_argument('Evaluation 9')
    ...
    tm = TestModule(args)
    print('-------------------------')
    print('Pattern (A): TC7 Only')
    tc6_rate = 0
    tc5_rate = 0
    num_frames = int(1000 * (tc7_rate + tc6_rate + tc5_rate) / tc7_rate)
    tm.test(tc7_rate, tc7_cir, tc6_rate, tc6_cir, tc5_rate, num_frames, 'results/tc7_only')

    print('-------------------------')
    print('Pattern (B): TC7 + TC6')
    if args.efcc_type == '1g':
        tc6_rate = 100
    elif args.efcc_type == '10g':
        tc6_rate = 1000
    tc5_rate = 0
    num_frames = int(1000 * (tc7_rate + tc6_rate + tc5_rate) / tc7_rate)
    tm.test(tc7_rate, tc7_cir, tc6_rate, tc6_cir, tc5_rate, num_frames, 'results/tc7_tc6')

    print('-------------------------')
    print('Pattern (C): TC7 + TC5')
    tc6_rate = 0
    if args.efcc_type == '1g':
        tc5_rate = 900
    elif args.efcc_type == '10g':
        tc5_rate = 9000
    num_frames = int(1000 * (tc7_rate + tc6_rate + tc5_rate) / tc7_rate)
    tm.test(tc7_rate, tc7_cir, tc6_rate, tc6_cir, tc5_rate, num_frames, 'results/tc7_tc5_900')

    print('-------------------------')
    print('Pattern (D): TC7 + TC6 + TC5')
    if args.efcc_type == '1g':
        tc6_rate = 100
        for tc5_rate in [100, 300, 500, 700, 900]:
            num_frames = int(1000 * (tc7_rate + tc6_rate + tc5_rate) / tc7_rate)
            tm.test(tc7_rate, tc7_cir, tc6_rate, tc6_cir, tc5_rate, num_frames, f'results/tc7_tc6_tc5_{tc5_rate}')
    elif args.efcc_type == '10g':
        tc6_rate = 1000
        for tc5_rate in [1000, 3000, 5000, 7000, 9000]:
            num_frames = int(1000 * (tc7_rate + tc6_rate + tc5_rate) / tc7_rate)
            tm.test(tc7_rate, tc7_cir, tc6_rate, tc6_cir, tc5_rate, num_frames, f'results/tc7_tc6_tc5_{tc5_rate}')
