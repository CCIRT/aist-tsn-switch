...
def main():
    ...
    parser.add_argument('--port1_cirs', default=[0, 1000, 3000, 5000, 7000, 9000, 10000], type=int, nargs='+', help='test port1 cirs')
    parser.add_argument('--max_residence_times', default=[MAX_RESIDENCE_TIME], type=int, nargs='+', help='test max residence times')
    ...
    for mrt in args.max_residence_times:
        for port1_cir in args.port1_cirs:
            ...
            if port1_cir == 0:
                ...
                num_frames = int(2000 * (port0_rate + port1_cir) / port0_rate)
