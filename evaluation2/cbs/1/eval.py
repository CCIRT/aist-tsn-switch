...
def main():
    print(f'Evaluation 1: Clarify the limitation of the measurement tool used in our experiments (i.e., tsn-efcc)')
    ...
    parser.add_argument('--frame_sizes', default=[64, 1500], type=int, nargs='+', help='test frame sizes')
